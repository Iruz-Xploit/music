...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5524856269").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Iruz-Xploit/musik",
)
...
)  # Example:- https://t.me/+kiUQED4H5mg5ZDUx
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", None
)  # Example:- https://t.me/deuznih
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "5510485760000")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "5550737410824")
)  # Remember to give value in bytes
